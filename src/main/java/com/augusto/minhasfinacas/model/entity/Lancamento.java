...
public class Lancamento {
	...
	@Override
	public int hashCode() {
		return Objects.hash(ano, dataCadastro, descrisao, id, mes, status, tipo, usuario, valor);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(ano, other.ano) && Objects.equals(dataCadastro, other.dataCadastro)
				&& Objects.equals(descrisao, other.descrisao) && Objects.equals(id, other.id)
	...
	public String toString() {
		return "Lancamento [id=" + id + ", descrisao=" + descrisao + ", mes=" + mes + ", ano=" + ano + ", usuario="
